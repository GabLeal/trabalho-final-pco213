...
\author{\IEEEauthorblockN{Luis Ricardo Santos}
\IEEEauthorblockA{\textit{Programa de Pós-Graduação} \\
...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{Figures/eda_overview.png}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=0.9\columnwidth]{Figures/pca_scree.png}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=0.95\columnwidth]{Figures/permutation_importance.png}}
...
\begin{figure}[t]
\centerline{\includegraphics[width=\columnwidth]{Figures/residuals.png}}
